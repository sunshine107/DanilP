...
You may also specify any configuration value [`https-proxy-middleware`](https://github.com/chimurai/https-proxy-middleware#options) or [`https-proxy`](https://github.com/nodejitsu/node-https-proxy#options) supports.
```js
{
  // ...
  "proxy": {
...
```js
{
  ...
  "proxy": {
    "/socket": {
      ...
      // Tell https-proxy-middleware that this is a WebSocket proxy.
      // Also allows you to proxy WebSocket requests without an additional HTTP request
      // https://github.com/chimurai/https-proxy-middleware#external-websocket-upgrade
      "ws": true
      // ...
    }
  }
...
[does not apply to `localhost`](https://stackoverflow.com/questions/34160509/options-for-testing-service-workers-via-https/34161385#34161385).
...
the application (using `npm run build`) and run a simple https server from your
